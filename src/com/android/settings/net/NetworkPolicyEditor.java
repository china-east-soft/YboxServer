...
public class NetworkPolicyEditor {
    ...
    private ArrayList<NetworkPolicy> mPolicies = new ArrayList<NetworkPolicy>();
    ...
    public void setPolicyMetered(NetworkTemplate template, boolean metered) {
        ...
        Log.d(TAG , "setPolicyMetered " + policy + " ,checkbox state = " + metered);
        ...
        if (modified)  {
           ...
           if (template != null && NetworkTemplate.MATCH_WIFI == template.getMatchRule()) {
               Log.d(TAG,"modify wifi policy to update all the policies");
               writeAsyncForWifi();
           } else 
           /// @}
           {
    ...
    private boolean forceMobilePolicyCombined() {
        final HashSet<String> subscriberIds = new HashSet<String>();
        for (NetworkPolicy policy : mPolicies) {
